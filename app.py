...
/* ── Force light mode variables on Gradio theme wrappers ── */
.gradio-container,
...
/* ── Dark mode overrides via Gradio's dark class ── */
.dark {
...
/* ── System-level dark mode fallback ── */
...
p, span, li, label, div, td, th, h1, h2, h3, h4, h5, h6 {
    color: inherit;
}

/* ── Gradio internal label/text overrides ── */
.gradio-container label,
.gradio-container .label-wrap span,
.gradio-container .prose,
.gradio-container span.svelte-1ipelgc {
    color: var(--text-primary) !important;
}
...
def create_app() -> gr.Blocks:
    with gr.Blocks(
        ...
        <span style="color:var(--text-secondary)">Project Lead • Full Stack AI Developer • UI/UX Designer</span></p>
        
        <p><span class="dev-name">Mr. Parmeshwar Kumar</span><br>
        <span style="color:var(--text-secondary)">Backend Developer • API Integration</span></p>
        
        <p><span class="dev-name">Mr. Amit Kumar</span><br>
        <span style="color:var(--text-secondary)">Machine Learning Engineer • Dataset & Model Training</span></p>
        
        <p><span class="dev-name">Mr. Prince Kumar Chaurasiya</span><br>
        <span style="color:var(--text-secondary)">Research & Documentation Lead</span></p>
        
        <p><span class="dev-name">Mr. Dhiraj Kumar</span><br>
        <span style="color:var(--text-secondary)">QA Engineer • Performance Testing</span></p>
        
        <p><span class="dev-name">MD. Tausim Akhtar</span><br>
        <span style="color:var(--text-secondary)">AI Research Contributor</span></p>
